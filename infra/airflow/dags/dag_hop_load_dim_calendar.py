...
default_args = {
'owner'                 : 'airflow',
'description'           : 'hop_load_dim_calendar_pipeline',
...
with DAG('hop_load_dim_calendar_pipeline', default_args=default_args, schedule_interval=None, catchup=False, is_paused_upon_creation=False) as dag:
